...
module.exports = {
    ...
    cooldown: 10000,
        ...
        const initialEmbed = new EmbedBuilder()
            .setTitle('Help page of PrivateParty 📚')
            .setURL('https://discord.gg/..')
            .setDescription('Below, you will find a menu with several categories that explains all of **my commands**. ⌚\n\n> If you have any questions about the bot, please join the [**PrivateParty\'s Server**](https://discord.gg/MhDheur2zg)')
