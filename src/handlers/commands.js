...
module.exports = (client) => {
    ...
    fs.readdirSync('./src/commands').forEach(async dir => {
        ...
        for (const file of cmdFiles) {
            ...
            if (cmd.name) {
                ...
                console.log(`Client - Loading failure ${file.split('.js')[0]}`);
            }
        }
    });
    ...
    (async () => {
        try {
            ...
            console.log(`Client - Application (/) commands registered overall`);
        } catch (e) {
            console.log(`Client - Failed to recording global commands (/)`, e);
        }
    })();
};